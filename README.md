...
Проект Cargo позволяет загружать данные в виде json файла, 
...
# Тесты:
В проете написаны тесты, используя библиотеки pytest и pytest-asyncio. Для запуска тестов необходимо прописать:
```
